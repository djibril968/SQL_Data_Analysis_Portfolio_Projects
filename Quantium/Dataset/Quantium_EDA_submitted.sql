...
/*
here we look at the difference between the date of last purchase of our customers and the last transaction date/sales cycle.
we look at customers whose last purchase date was above 60 days
*/
...
---we complete our MBA utilizing metrics such as Frequency, Support, Confidence and LIFT
WITH mba_cte 
AS				
(
		SELECT p1.txn_id,  
...
-----------------------------------now we look for frequency, support, confidence and LIFT
